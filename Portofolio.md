...
|---|---|---:|---|
| Code4rena | Swafe | Medium | Valid Finding |
...
<img src="https://skillicons.dev/icons?i=solidity,rust,go" />
...
Review Solidity codebases to identify:
...
Focused review of specific contracts, functions, or protocol components.

Security Research

Independent security research and vulnerability discovery for blockchain protocols.

Retesting

Verification of fixes after vulnerabilities have been addressed.
